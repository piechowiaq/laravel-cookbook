    ...
    <div class="bg-white rounded-md border my-8 px-6 py-6">
        <div>
            ...
            <form action="/announcement/update" method="POST" class="max-w-2xl mt-4" id="updateAnnouncement" enctype="multipart/form-data">
                ...
                <div class="mt-4">
                    <label for="imageUploadFilePond" class="font-semibold block">Image UploadFilePond</label>
                ...
                @if($announcement->imageUploadFilePond)
                    <div class="mt-4">
                        <img src="{{ asset('storage/'.$announcement->imageUploadFilePond) }}" alt="image" class="max-w-xs">
                    </div>
                @endif
